...
- To access the quantity needed, the following structure must be used:
      - get_dataframe(link to ERG file, quantity desired, link to time-dist text file)
...
The dataframe also has statistics series, such as Mean, Median, Standard Deviation and Standard Error. These values are based on the last 5 laps by default.
